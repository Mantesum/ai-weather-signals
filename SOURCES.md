...
- China media: current CGTN China/World and China News Service scroll/China/society RSS feeds are merged into bounded sources; Sixth Tone is consumed through its direct RSS feed. A native bounded adapter reads CCTV's current China and society JSONP lists directly. The technically reachable China Daily, People's Daily, Sina, Global Times and legacy English Xinhua feeds are deliberately excluded because their published entries are stale.
