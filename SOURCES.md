...
- Mastodon: selected instance + hashtag REST timeline. Public preview may be disabled. Respect `X-RateLimit-*` headers and instance policy; a token is an environment variable.
